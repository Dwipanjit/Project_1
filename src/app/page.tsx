        ...
        <div className="container mx-auto px-4 py-8 relative z-10">
          ...
          <div className="text-center mb-16">
            <div className="mb-8">
              ...
              <p className="text-xl md:text-2xl text-blue-300 mb-6 max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              <a
                ...
                className="group flex items-center space-x-2 bg-white/10 backdrop-blur-lg border border-white/20 px-4 py-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
              >
